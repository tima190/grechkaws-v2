...
<template>
  <div class="h-full w-full flex items-start justify-start bg-#FFFBDE relative">
    <h1 class="text-7xl pl-20 pt-20 font-bold text-left text-#096B68"
      style="display: block; line-clamp: 2; text-overflow: ellipsis;">
      {{ title }}
    </h1>
    <p class="text-2xl pl-20 font-bold text-left text-[#096B68] w-3/4 break-words">
      {{ description }}
    </p>
    <p class="text-2xl pl-20 text-[#096B68] w-3/4 break-words">
      // grechkagk.com //
     </p>

    <img src="/img/mii/happy.png" width="256" height="256" class="absolute right-0 mr-10 mt-20" alt="corner image" />

    <svg class="absolute bottom-0 left-0 right-0" viewBox="0 0 1200 627" width="1200" height="627"
      ...
      <path
        ...
        fill="#096B68" strokeLinecap="round" strokeLinejoin="miter" />
    </svg>
  </div>
</template>